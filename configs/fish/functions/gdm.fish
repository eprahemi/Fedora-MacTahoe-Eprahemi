...
function gdm --description 'Change GDM login screen wallpaper — needs internet only the first time — github.com/eprahemi/FedoraTahoe-GDM'
    ...
    if not set -q argv[1]
        ...
        set -l n3b "          →  search by name across XDG folders"
        echo -e "  $CY║$C  $D$n3b$C$(printf '%*s' (math "60 - "(string length "$n3b")) '')$CY║$C"
        set -l n4 "    gdm /path/to/image.jpg"
        echo -e "  $CY║$C  $CY$B$n4$C$(printf '%*s' (math "60 - "(string length "$n4")) '')$CY║$C"
        set -l n4b "          →  use an exact file path"
        echo -e "  $CY║$C  $D$n4b$C$(printf '%*s' (math "60 - "(string length "$n4b")) '')$CY║$C"
        set -l n5 "    gdm default"
        echo -e "  $CY║$C  $CY$B$n5$C$(printf '%*s' (math "60 - "(string length "$n5")) '')$CY║$C"
        set -l n5b_des "          →  restore Default login wallpaper"
        echo -e "  $CY║$C  $D$n5b_des$C$(printf '%*s' (math "60 - "(string length "$n5b_des")) '')$CY║$C"
        set -l n5b "    gdm info"
        echo -e "  $CY║$C  $CY$B$n5b$C$(printf '%*s' (math "60 - "(string length "$n5b")) '')$CY║$C"
        set -l n5b_des2 "          →  show last-applied wallpaper details"
        echo -e "  $CY║$C  $D$n5b_des2$C$(printf '%*s' (math "60 - "(string length "$n5b_des2")) '')$CY║$C"
        set -l n5c "    gdm save"
        ...
        echo -e "  $CY║$C  $D$n6b$C$(printf '%*s' (math "60 - "(string length "$n6b")) '')$CY║$C"
        echo -e "  $CY║$C$(printf '%*s' 62 '')$CY║$C"
        echo -e "  $CY╠══════════════════════════════════════════════════════════════╣$C"
        echo -e "  $CY║$C$(printf '%*s' 62 '')$CY║$C"
    ...
    if set -q argv[1]; and contains -- "$argv[1]" "default" "--default"
        ...
        if test -f "$wp_repo"
            ...
            if test $dl_ok -eq 0
                ...
                echo -e "  $RE│$C     $WH$ni1$C$(printf '%*s' (math "55 - "(string length "$ni1")) '')$RE│$C"
                echo -e "  $RE│$C$(printf '%*s' 60 '')$RE│$C"
                echo -e "  $RE│$C  $D  The Himeno login wallpaper was not found$C$RE        │$C"
                echo -e "  $RE│$C  $D  locally and could not be downloaded.$C$RE           │$C"
                echo -e "  $RE│$C$(printf '%*s' 60 '')$RE│$C"
                echo -e "  $RE│$C     $D──────────────────────────────────────────$C$RE      │$C"
                echo -e "  $RE│$C$(printf '%*s' 60 '')$RE│$C"
                echo -e "  $RE│$C     $YE  Connect to the internet, or apply a$C$RE         │$C"
                echo -e "  $RE│$C     $YE  custom wallpaper instead:$C$RE                   │$C"
                echo -e "  $RE│$C$(printf '%*s' 60 '')$RE│$C"
...
" "$sr_val" 2>/dev/null)
    ...
    switch $result_count
        case 0
            ...
            if string match -q -- "help" "$filename"
                echo -e "  $GY  If you meant a .jpg — it is not there.$C"
    ...
    if test $need_clone -eq 1
        ...
        echo -e "  $CY│$C     $CY$B$i1$C$(printf '%*s' (math "55 - "(string length "$i1")) '')$CY│$C"
        echo -e "  $CY│$C$(printf '%*s' 60 '')$CY│$C"
        echo -e "  $CY│$C  $D  The FedoraTahoe-GDM engine needs to be$C$CY           │$C"
        echo -e "  $CY│$C  $D  downloaded to your system for GDM$C$CY                │$C"
        echo -e "  $CY│$C  $D  wallpaper support.$C$CY                               │$C"
        echo -e "  $CY│$C$(printf '%*s' 60 '')$CY│$C"
        echo -e "  $CY│$C     $D──────────────────────────────────────────$C$CY      │$C"
        echo -e "  $CY│$C$(printf '%*s' 60 '')$CY│$C"
        ...
        if test $has_net -eq 0
            ...
            echo -e "  $RE│$C     $WH$ni1$C$(printf '%*s' (math "55 - "(string length "$ni1")) '')$RE│$C"
            echo -e "  $RE│$C$(printf '%*s' 60 '')$RE│$C"
            echo -e "  $RE│$C  $D  The wallpaper engine files are missing$C$RE           │$C"
            echo -e "  $RE│$C  $D  and cannot be downloaded without an$C$RE             │$C"
            echo -e "  $RE│$C  $D  internet connection.$C$RE                            │$C"
            echo -e "  $RE│$C$(printf '%*s' 60 '')$RE│$C"
            echo -e "  $RE│$C     $D──────────────────────────────────────────$C$RE      │$C"
            echo -e "  $RE│$C$(printf '%*s' 60 '')$RE│$C"
        ...
        if not command -v git &>/dev/null
            ...
            echo -e "  $CY│$C     $YE$gi1$C$(printf '%*s' (math "55 - "(string length "$gi1")) '')$CY│$C"
            echo -e "  $CY│$C$(printf '%*s' 60 '')$CY│$C"
            echo -e "  $CY│$C  $D  git is required to download the wallpaper$C$CY       │$C"
            echo -e "  $CY│$C  $D  engine but is not installed on your$C$CY             │$C"
            echo -e "  $CY│$C  $D  system.$C$CY                                        │$C"
            echo -e "  $CY│$C$(printf '%*s' 60 '')$CY│$C"
            echo -e "  $CY│$C     $D──────────────────────────────────────────$C$CY      │$C"
            echo -e "  $CY│$C$(printf '%*s' 60 '')$CY│$C"
            echo -e "  $CY│$C     $GR  [Y]  Install git$C$CY                            │$C"
        ...
        if not git clone --depth 1 https://github.com/eprahemi/FedoraTahoe-GDM.git "$repo" 2>/dev/null
            ...
            echo -e "  $RE│$C     $WH$cf1$C$(printf '%*s' (math "55 - "(string length "$cf1")) '')$RE│$C"
            echo -e "  $RE│$C$(printf '%*s' 60 '')$RE│$C"
            echo -e "  $RE│$C  $D  Unable to download the wallpaper engine.$C$RE         │$C"
            echo -e "  $RE│$C  $D  Check your internet connection and try$C$RE           │$C"
