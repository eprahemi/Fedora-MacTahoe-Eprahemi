...
n_iss1="  ◆  Broken display resolution or no display at all"
    echo -e "  ${YELLOW}║${NC}  ${BOLD}${RED}${n_iss1}$(printf '%*s' $((62 - ${#n_iss1})) '')${NC}${YELLOW}║${NC}"
n_iss2="  ◆  Screen tearing and poor graphical performance"
    echo -e "  ${YELLOW}║${NC}  ${BOLD}${RED}${n_iss2}$(printf '%*s' $((62 - ${#n_iss2})) '')${NC}${YELLOW}║${NC}"
n_iss3="  ◆  Network connectivity breaking (WiFi/Ethernet)"
    echo -e "  ${YELLOW}║${NC}  ${BOLD}${RED}${n_iss3}$(printf '%*s' $((62 - ${#n_iss3})) '')${NC}${YELLOW}║${NC}"
n_iss4="  ◆  GPU overheating due to missing or wrong driver"
    echo -e "  ${YELLOW}║${NC}  ${BOLD}${RED}${n_iss4}$(printf '%*s' $((62 - ${#n_iss4})) '')${NC}${YELLOW}║${NC}"
n_iss5="  ◆  System instability, freezes, or boot loops"
    echo -e "  ${YELLOW}║${NC}  ${BOLD}${RED}${n_iss5}$(printf '%*s' $((62 - ${#n_iss5})) '')${NC}${YELLOW}║${NC}"
n_iss6="  ◆  Being stuck on the open-source nouveau driver"
    echo -e "  ${YELLOW}║${NC}  ${BOLD}${RED}${n_iss6}$(printf '%*s' $((62 - ${#n_iss6})) '')${NC}${YELLOW}║${NC}"
    echo -e "  ${YELLOW}║${NC}                                                              ${YELLOW}║${NC}"
...
n10="    1. Ensure you have a working internet connection"
    echo -e "  ${YELLOW}║${NC}  ${n10}$(printf '%*s' $((62 - ${#n10})) '')${YELLOW}║${NC}"
n11="    2. Run:  sudo dnf upgrade  (update all packages)"
    echo -e "  ${YELLOW}║${NC}  ${BOLD}${n11}$(printf '%*s' $((62 - ${#n11})) '')${YELLOW}║${NC}"
n12="    3. Reboot to load the latest kernel"
    echo -e "  ${YELLOW}║${NC}  ${n12}$(printf '%*s' $((62 - ${#n12})) '')${YELLOW}║${NC}"
n13="    4. Re-run this installer"
    echo -e "  ${YELLOW}║${NC}  ${n13}$(printf '%*s' $((62 - ${#n13})) '')${YELLOW}║${NC}"
    echo -e "  ${YELLOW}║${NC}                                                              ${YELLOW}║${NC}"
...
n15="  running the latest Fedora kernel, you can safely"
    echo -e "  ${YELLOW}║${NC}     ${n15}$(printf '%*s' $((60 - ${#n15})) '')${YELLOW}║${NC}"
n16="  proceed — the installer will handle the rest."
    echo -e "  ${YELLOW}║${NC}     ${n16}$(printf '%*s' $((60 - ${#n16})) '')${YELLOW}║${NC}"
    echo -e "  ${YELLOW}║${NC}                                                              ${YELLOW}║${NC}"
