...
n_title="  HEADS UP — NVIDIA DETECTED"
  echo -e "  ${YELLOW}╔══════════════════════════════════════════════════════════════╗${NC}"
  echo -e "  ${YELLOW}║${NC}  ${BOLD}${n_title}${NC}$(printf '%*s' $((60 - ${#n_title})) '')${YELLOW}║${NC}"
  echo -e "  ${YELLOW}╠══════════════════════════════════════════════════════════════╣${NC}"
  echo -e "  ${YELLOW}║${NC}                                                              ${YELLOW}║${NC}"
n1="  You've got NVIDIA gear. On a fresh install, running this"
  echo -e "  ${YELLOW}║${NC}  ${n1}$(printf '%*s' $((60 - ${#n1})) '')${YELLOW}║${NC}"
n2="  before a full system update can mess up your display."
  echo -e "  ${YELLOW}║${NC}  ${n2}$(printf '%*s' $((60 - ${#n2})) '')${YELLOW}║${NC}"
n3="  Think 800x600 resolution and laggy refresh. Not fun."
  echo -e "  ${YELLOW}║${NC}  ${n3}$(printf '%*s' $((60 - ${#n3})) '')${YELLOW}║${NC}"
  echo -e "  ${YELLOW}║${NC}                                                              ${YELLOW}║${NC}"
n4="  Save yourself the headache — do this first:"
  echo -e "  ${YELLOW}║${NC}  ${BOLD}${n4}$(printf '%*s' $((60 - ${#n4})) '')${YELLOW}║${NC}"
n_step1="    1. Get online (ethernet > WiFi if you can)"
  echo -e "  ${YELLOW}║${NC}${n_step1}$(printf '%*s' $((62 - ${#n_step1})) '')${YELLOW}║${NC}"
n_step2="    2. sudo dnf upgrade"
  echo -e "  ${YELLOW}║${NC}${BOLD}${n_step2}$(printf '%*s' $((62 - ${#n_step2})) '')${YELLOW}║${NC}"
n_step3="    3. Reboot"
  echo -e "  ${YELLOW}║${NC}${n_step3}$(printf '%*s' $((62 - ${#n_step3})) '')${YELLOW}║${NC}"
n_step4="    4. Run this thing again"
  echo -e "  ${YELLOW}║${NC}${n_step4}$(printf '%*s' $((62 - ${#n_step4})) '')${YELLOW}║${NC}"
  echo -e "  ${YELLOW}║${NC}                                                              ${YELLOW}║${NC}"
n_updated="  ✓  Already updated? Press any key to roll."
  echo -e "  ${YELLOW}║${NC}  ${GREEN}${n_updated}$(printf '%*s' $((60 - ${#n_updated})) '')${YELLOW}║${NC}"
n_ctrlc="  Ctrl+C to go update first"
  echo -e "  ${YELLOW}║${NC}  ${n_ctrlc}$(printf '%*s' $((60 - ${#n_ctrlc})) '')${YELLOW}║${NC}"
  echo -e "  ${YELLOW}╚══════════════════════════════════════════════════════════════╝${NC}"
  echo ""
...
disc4="    no   — Skip it"
    ...
    echo -e "  ${CYAN}║${NC}                                                              ${CYAN}║${NC}"
disc5="  Press Enter for default (Yes)"
...
desk3="    no   — Keep current wallpaper"
    ...
    echo -e "  ${CYAN}║${NC}                                                              ${CYAN}║${NC}"
desk4="  (Login screen wallpaper is always applied)"
...
m4="  If you enjoyed this project, consider starring ⭐ on GitHub"
  echo -e "  ${DIM}│${NC}  ${DIM}${m4}${NC}$(printf '%*s' $((63 - ${#m4})) '')${DIM}│${NC}"
  echo -e "  ${DIM}╰${NC}${DIM}─────────────────────────────────────────────────────────────────╯${NC}"
  echo ""
  echo -e "  ${YELLOW}╔══════════════════════════════════════════════════════════════╗${NC}"
