...
prompt_sudoers_entry() {
  if [ -z "${INSTALL_SUDOERS_HINT:-}" ]; then
    ...
    echo -e "  ${CYAN}╠══════════════════════════════════════════════════════════════╣${NC}"
    echo -e "  ${CYAN}║${NC}                                                              ${CYAN}║${NC}"
    echo -e "  ${CYAN}║${NC}  When you use ${BOLD}sudo${NC}, Linux asks for your password every time.       ${CYAN}║${NC}"
    echo -e "  ${CYAN}║${NC}  If you want to stop typing it over and over, you can enable             ${CYAN}║${NC}"
    echo -e "  ${CYAN}║${NC}  ${BOLD}passwordless sudo${NC} — it lets you run sudo commands without a         ${CYAN}║${NC}"
    echo -e "  ${CYAN}║${NC}  password.                                                                 ${CYAN}║${NC}"
    echo -e "  ${CYAN}║${NC}                                                              ${CYAN}║${NC}"
    echo -e "  ${CYAN}║${NC}  This option will ${BOLD}${YELLOW}add a commented line${NC} at the end of a special       ${CYAN}║${NC}"
    echo -e "  ${CYAN}║${NC}  system file called ${DIM}/etc/sudoers${NC}. The line starts with a ${BOLD}#${NC},        ${CYAN}║${NC}"
    echo -e "  ${CYAN}║${NC}  which means it does ${BOLD}NOTHING${NC} yet. It is perfectly safe and              ${CYAN}║${NC}"
    echo -e "  ${CYAN}║${NC}  changes nothing right now. It is just a shortcut for later.              ${CYAN}║${NC}"
    echo -e "  ${CYAN}║${NC}                                                              ${CYAN}║${NC}"
    echo -e "  ${CYAN}║${NC}  ${BOLD}If you say yes:${NC}                                                     ${CYAN}║${NC}"
    echo -e "  ${CYAN}║${NC}    1. One line goes at the bottom of /etc/sudoers:                          ${CYAN}║${NC}"
    echo -e "  ${CYAN}║${NC}       ${DIM}# your_username ALL=(ALL) NOPASSWD: ALL${NC}                            ${CYAN}║${NC}"
    echo -e "  ${CYAN}║${NC}    2. The ${BOLD}#${NC} makes it a comment — does nothing                           ${CYAN}║${NC}"
    echo -e "  ${CYAN}║${NC}    3. Later, to enable it, run:                                              ${CYAN}║${NC}"
    echo -e "  ${CYAN}║${NC}       ${BOLD}sudo visudo${NC}                                                      ${CYAN}║${NC}"
    echo -e "  ${CYAN}║${NC}    4. Scroll to bottom and delete the ${BOLD}#${NC} at the start of the            ${CYAN}║${NC}"
    echo -e "  ${CYAN}║${NC}       line                                                                    ${CYAN}║${NC}"
    echo -e "  ${CYAN}║${NC}    5. Save and exit — no more password prompts                                 ${CYAN}║${NC}"
    echo -e "  ${CYAN}║${NC}                                                              ${CYAN}║${NC}"
    echo -e "  ${CYAN}║${NC}    ${BOLD}${YELLOW}y${NC}${BOLD}es${NC}  — Yes, add the commented line for me                         ${CYAN}║${NC}"
    echo -e "  ${CYAN}║${NC}    ${BOLD}${GREEN}N${NC}${BOLD}o${NC}   — No thanks, skip this (default)                                 ${CYAN}║${NC}"
    echo -e "  ${CYAN}║${NC}                                                              ${CYAN}║${NC}"
    echo -e "  ${CYAN}║${NC}  ${DIM}We never touch your existing sudoers lines. We only add ONE              ${CYAN}║${NC}"
    echo -e "  ${CYAN}║${NC}  ${DIM}new commented line at the bottom, and only if you say YES.              ${CYAN}║${NC}"
    echo -e "  ${CYAN}║${NC}  ${DIM}If you run again, it sees the line exists and skips.                   ${CYAN}║${NC}"
    echo -e "  ${CYAN}║${NC}                                                              ${CYAN}║${NC}"
    echo -e "  ${CYAN}║${NC}  ${BOLD}${GREEN}Your data is safe and encrypted. Nothing leaves your computer.${NC}     ${CYAN}║${NC}"
    echo -e "  ${CYAN}╚══════════════════════════════════════════════════════════════╝${NC}"
