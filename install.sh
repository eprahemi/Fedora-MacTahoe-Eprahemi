...
n_iss1="  ◆  Broken display resolution or no display at all"
    echo -e "  ${YELLOW}║${NC}  ${n_iss1}$(printf '%*s' $((62 - ${#n_iss1})) '')${YELLOW}║${NC}"
n_iss2="  ◆  Screen tearing and poor graphical performance"
    echo -e "  ${YELLOW}║${NC}  ${n_iss2}$(printf '%*s' $((62 - ${#n_iss2})) '')${YELLOW}║${NC}"
n_iss3="  ◆  Network connectivity breaking (WiFi/Ethernet)"
    echo -e "  ${YELLOW}║${NC}  ${n_iss3}$(printf '%*s' $((62 - ${#n_iss3})) '')${YELLOW}║${NC}"
n_iss4="  ◆  GPU overheating due to missing or wrong driver"
    echo -e "  ${YELLOW}║${NC}  ${n_iss4}$(printf '%*s' $((62 - ${#n_iss4})) '')${YELLOW}║${NC}"
n_iss5="  ◆  System instability, freezes, or boot loops"
    echo -e "  ${YELLOW}║${NC}  ${n_iss5}$(printf '%*s' $((62 - ${#n_iss5})) '')${YELLOW}║${NC}"
n_iss6="  ◆  Being stuck on the open-source nouveau driver"
    echo -e "  ${YELLOW}║${NC}  ${n_iss6}$(printf '%*s' $((62 - ${#n_iss6})) '')${YELLOW}║${NC}"
    echo -e "  ${YELLOW}║${NC}                                                              ${YELLOW}║${NC}"
